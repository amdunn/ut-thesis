...
\renewcommand{\thesisauthorpreviousdegrees}{}
                                     ...
                                     %% abbreviated; separate multiple
                                     %% degrees by semicolons, if same
                                     %% degree acquired more than once
                                     %% (e.g. 2 bachelor's degrees)
                                     %% list twice.  Enter all degrees
                                     %% regardless of field
                                     %% (e.g. master's in some other
                                     %% field should be in there).
...
\input{ack}                          %% acknowledgments; it can be anything
\end{thesisacknowledgments}          %% allowed in LaTeX2e par-mode.

% AD: Unlike normal, do not use \begin{abstract}/\end{abstract} as
% this puts the abstract on a new page, which does not follow format
% guidelines.  350 words or less!
\begin{thesisabstract}               %% Use this to write your thesis
\input{abstract}                     %% abstract; it can be anything
...
\input{vita}                         %% anything in LaTeX2e par-mode.
